...
void test3()
{
   ...
   for(int k=0; k<1000; k++)
   {
      ...
      for(int hit=0; hit < No_Ch; hit++)
       ...
       for(int ht = 0; ht< No_Ch; ht++)
       {leaf_channel = ch_id[ht];
       cout<<leaf_channel<<endl;
       }
      }
   }   
     /*            
     ...
     /*   for(int hit=0; hit < No_Ch; hit++)
      {
       ...
       //        y1count = y1count + 1;
             ...
             Wall_id1[leaf_row][leaf_column] = 1; 
          }
         ...
         //      y2count = y2count + 1;
             ...
             Wall_id2[leaf_row][leaf_column] = 1; 
          }
         ...
         //      y3count = y3count + 1;
             ...
             Wall_id3[leaf_row][leaf_column] = 1; 
          }
          }
         } 
    */          
