...
int main()
{
   ...
   */
   ...
   TH1D* h1 = new TH1D("h1", "Resolution XZ; | #Delta (#theta_{hough} - #theta_{gen}) |; Entries;", 1000, 0.0, 10.0);
   TH1D* h2 = new TH1D("h2", "Resolution YZ; | #Delta (#theta_{hough} - #theta_{gen}) |; Entries;", 1000, 0.0, 10.0);
