...
// Wed May 25 09:41:14 2022 by ROOT version 6.18/00
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           TB_channelC[1288];   //[NTouchedChannel]
   Int_t           TB_DMchannel[1288];   //[NTouchedChannel]
   Float_t         TB_pe[1288];   //[NTouchedChannel]
   Float_t         TB_time[1288];   //[NTouchedChannel]
   Int_t           TB_ADC[1288];   //[NTouchedChannel]
   Float_t         TB_xcC[1288];   //[NTouchedChannel]
   Float_t         TB_ycC[1288];   //[NTouchedChannel]
   Float_t         TB_zcC[1288];   //[NTouchedChannel]
   Int_t           TB_is_ctC[1288];   //[NTouchedChannel]
   Int_t           TB_isMuonDepositsC[1288];   //[NTouchedChannel]
