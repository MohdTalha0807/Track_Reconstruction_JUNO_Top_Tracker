...
int main()
{
   ...
   */
   ...
   TH1D* h1 = new TH1D("h1", "Resolution XZ;  #Delta (#theta_{hough} - #theta_{true})  (degree); Number of single Tracks;", 300, -3.0, 3.0);
   TH1D* h2 = new TH1D("h2", "Resolution YZ;  #Delta (#theta_{hough} - #theta_{true})  (degree); Number of single Tracks;", 300, -3.0, 3.0);
  // TH1D* h3 = new TH1D("h2", ";;;", 500, 0.0, 10.0);
   ...
   {   th_genXZ = th_rh_XZ_gen -> at(j);
      ...
      {   
       ...
       //cout<<th_rh_XZ_gen -> at(j)<<"\t"<<th_rh_XZ_hough -> at(j)<<endl; 
         ...
         delta_thXZ = (th_genXZ - th_houghXZ); 
   ...
   {  //cout<<"num tr gen = "<<num_trYZ_gen<<endl; 
      ...
      {  // cout<<"num tr hough = "<<num_trYZ_hough<<endl;
       ...
       //cout<<th_rh_YZ_gen -> at(j)<<"\t"<<th_rh_YZ_hough -> at(j)<<endl; 
         ...
         delta_thYZ = (th_genYZ - th_houghYZ); 
