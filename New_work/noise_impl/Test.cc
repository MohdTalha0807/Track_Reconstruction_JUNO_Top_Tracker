...
/*--------------------------------------------- Checking for the XY coincidences on all the three layers and rejecting hits with no such coincidence ----------------------------------*/
     ...
     //-----------------------------------------------------------adding noise to the muon hits------------------------------------            
          ...
          //   cout<<"random ch id = "<<rand_ind<<endl;
           ...
           cout<<"number of noise hits = "<<num_noise_hits<<endl;
      ...
      { //5      
         ...
         { //    if(theta_pos_x[i] > 0)
           ...
           // } 
              ...
              Double_t new_rho_minXZ = rho_pos_x[i] - 80.0 + jt * ((double)dlt_rhoXZ/ 10.0);
              Double_t new_rho_maxXZ = rho_pos_x[i] + 80.0 + jt * ((double)dlt_rhoXZ/ 10.0);
          ...
          //   }
           ...
           // } 
            // cout<<theta_pos_y[i]<<endl;
             ...
             Double_t new_rho_minYZ = rho_pos_y[i] - 50.0 + jt * (dlt_rhoYZ/ 10.0);
             Double_t new_rho_maxYZ = rho_pos_y[i] + 50.0 + jt * (dlt_rhoYZ/ 10.0);
