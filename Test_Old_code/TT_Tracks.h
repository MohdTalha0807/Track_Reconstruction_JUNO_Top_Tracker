...
// Mon May 23 23:41:52 2022 by ROOT version 6.24/02
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<float>   *CoordX_hough;
   vector<float>   *CoordX;
   vector<float>   *CoordZX;
   vector<float>   *CoordY_hough;
   vector<float>   *CoordY;
   vector<float>   *CoordZY;
   ...
   TBranch        *b_CoordX_hough;   //!
   TBranch        *b_CoordX;   //!
   TBranch        *b_CoordZX;   //!
   TBranch        *b_CoordY_hough;   //!
   TBranch        *b_CoordY;   //!
   TBranch        *b_CoordZY;   //!
...
void TT_Tracks::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("Evt_ID", &Evt_ID, &b_Ev_Id);
   ...
   fChain->SetBranchAddress("CoordX_hough", &CoordX_hough, &b_CoordX_hough);
   fChain->SetBranchAddress("CoordX", &CoordX, &b_CoordX);
   fChain->SetBranchAddress("CoordZX", &CoordZX, &b_CoordZX);
   fChain->SetBranchAddress("CoordY_hough", &CoordY_hough, &b_CoordY_hough);
   fChain->SetBranchAddress("CoordY", &CoordY, &b_CoordY);
   fChain->SetBranchAddress("CoordZY", &CoordZY, &b_CoordZY);
   Notify();
}
